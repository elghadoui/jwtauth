...
const ProductListCard = ({ data, loading }) => {
    if (loading) {
        return (
    ...
    // Fonction pour obtenir les initiales du produit
    ...
    return (
        <div>
            ...
            <div className="space-y-3">
                ...
                const productName = item.produit || item.codvar || 'Inconnu';
                ...
                return (
                    ...
                    >
                        ...
                        <div
                            className={`w-10 h-10 ${getColor(productName)} rounded-full flex items-center justify-center text-white font-semibold text-sm flex-shrink-0`}
                        >
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-gray-600 truncate font-medium">{productName}</p>
                        </div>
